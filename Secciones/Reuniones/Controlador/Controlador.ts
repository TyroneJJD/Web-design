...
import {
  generarReunion,
  identificacion,
} from "../../../Servicios/GestorReuniones.ts";
import {
...
export const directorioVistaSeccionActual =
  `${Deno.cwd()}/Secciones/Reuniones/Vista_Reuniones`;
...
export function inicializarReuniones(
  ...
  router.get(
    ...
    verificadorAutenticacion,
    verificarSiEsCoach,
    gestorCalendarioEntrevistador.mostrarCalendarioEntrevistador,
  );
  router.post(
    "/generar-reuniones",
    verificadorAutenticacion,
    verificarSiEsCoach,
    gestorCalendarioEntrevistador.generarReuniones,
  );
  router.post(
    "/asignarCandidatoAReunion",
    verificadorAutenticacion,
    verificarSiEsCoach,
    gestorCalendarioEntrevistador.asignarCandidatoAReunion,
  );
  ...
  router.get(
    "/calendarioTrainee",
    verificadorAutenticacion,
    gestorCalendarioTrainee.mostrarCalendarioTrainee,
  );

  //-----------------------------------------//
  const gestorReservacionEntrenador = new ReservacionEntrenador();
  router.get(
    "/reservacionEntrenador",
    verificadorAutenticacion,
    gestorReservacionEntrenador.mostrarReservacionEntrenador,
  );
  router.post(
    "/inscribirme-reunion",
    verificadorAutenticacion,
    gestorReservacionEntrenador.inscribirmeASesion,
  );
