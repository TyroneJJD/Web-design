export interface SesionEntrevista {
  ...
  horaInicio: Date;
  horaFin: Date;
  candidatosRegistrados: candidatosRegistrado[];
  candidatoSeleccionadoAEntrevistar: candidatosRegistrado;
  sesionOcupada: boolean;
}

interface candidatosRegistrado {
...
export class Agenda {
  ...
  public obtenerSesionesDisponiblesDeEntrevista(): SesionEntrevista[] {
    ...
    while (inicioEntrevista < this.fechaFin) {
      ...
      sesiones.push({
        ...
        candidatoSeleccionadoAEntrevistar: new Object() as candidatosRegistrado,
        sesionOcupada: false,
      });
